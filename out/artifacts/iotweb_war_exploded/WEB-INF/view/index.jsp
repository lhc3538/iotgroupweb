        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="thumbnail content-thumbnail mv_float">
                    ...
                    <div class="caption">
                        <h4>信息安全方向</h4>
                        <p>信息安全涵盖计算机应用，计算机网络，操作系统等各个层面。总体分为两大方向，渗透测试 + 逆向工程。交流群：545114264</p>
                        <a class="btn btn-danger" href="showsubpage?id=8">学习路线</a> <!--a class="btn btn-info" href="source">相关资源</a-->
                    </div>
                </div>
            </div>
        </div>
